1. Project Title
📱 Mobile Device Usage Analysis Dashboard | Power BI

2. Short Description
This project is an interactive **Power BI dashboard** that analyzes mobile device usage patterns to uncover user behavior, device preferences, app engagement, and usage trends. The dashboard transforms raw mobile usage data into actionable insights through interactive visualizations and KPIs, enabling stakeholders to understand customer behavior and support data-driven business decisions.
...
-Enables comparison of usage metrics across multiple dimensions.
-Provides interactive filtering for deeper analysis of user behavior.
